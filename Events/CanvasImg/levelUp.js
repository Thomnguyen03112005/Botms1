...
GlobalFonts.registerFromPath(`${path.join(path.dirname(fileURLToPath(import.meta.url)), ".")}/fonts/Poppins-Regular.ttf`,"Poppins");
GlobalFonts.registerFromPath(`${path.join(path.dirname(fileURLToPath(import.meta.url)), ".")}/fonts/Poppins-Bold.ttf`,"Poppins Bold");
