import { StringSelectMenuBuilder, EmbedBuilder, PermissionFlagsBits, ComponentType, ActionRowBuilder, ButtonBuilder, TextInputBuilder, TextInputStyle, ModalBuilder } from "discord.js";
import { classComponent } from "./components.js";
import { EmbedBuilders } from "../functions.js";
...
export function embedCreator(msgOrInt, options = { strict: false }) {
  return new Promise(async(resolve) => {
    try {
      const misc_1 = new classComponent();
