...
import { music as PlayMusicData } from "../Assets/Schemas/databases.js";
import { updateMusicSystem } from "../../Handlers/DistubeEvents.js";
...
const musicInteraction = new eventBuilders({
    ...
    executeEvents: async (client, interaction) => {
        ...
        const data = await PlayMusicData.get(interaction.guild.id);
