import { ActionRowBuilder, ButtonBuilder, ModalBuilder, TextInputBuilder, ChannelType, TextInputStyle, ComponentType } from "discord.js";
import { EmbedBuilders, addComponents, classComponent } from "../Events/functions.js";
import { giveawayModel } from "../Events/Assets/Schemas/databases.js";
...
const GiveawaysHandlers = class extends GiveawaysManager {
  ...
  async deleteGiveaway(messageId) {
    ...
    await giveawayModel.delete(messageId);
    return true;
  };
  /*========================================================
  # Chạy các events
...
export default function GiveawayHandlers(client) {
